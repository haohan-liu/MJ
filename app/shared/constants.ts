...
export const USER_SETTING_KEYS = {
  ...
  GENERAL_AUTO_COMPRESS_REF_IMAGE: 'general.autoCompressRefImage',
  // 绘图设置（仅保存 aimodelId）
...
5. 使用中文输出提示词内容，但可保留专业英文关键词（如艺术风格词、模型参数等）
...
export const USER_SETTING_DEFAULTS: Record<UserSettingKey, UserSettingValue> = {
  ...
  [USER_SETTING_KEYS.GENERAL_AUTO_COMPRESS_REF_IMAGE]: true,
...
export const SITE_SETTING_KEYS = {
  ...
  API_PLATFORM_URL: 'apiPlatform.url',
  API_PLATFORM_NAME: 'apiPlatform.name',
  NEW_API_BASE_URL: 'newApi.baseUrl',
  TASK_RETENTION_DAYS: 'task.retentionDays',
  // 存储配置
  STORAGE_TYPE: 'storage.type', // local | cos
...
export const SITE_SETTING_DEFAULTS: Record<SiteSettingKey, string> = {
  [SITE_SETTING_KEYS.SITE_NAME]: 'MJ Studio',
  [SITE_SETTING_KEYS.SITE_SLOGAN]: 'AI 创作工作台',
  [SITE_SETTING_KEYS.SITE_COPYRIGHT]: '',
  [SITE_SETTING_KEYS.SITE_LOGO_URL]: '',
  [SITE_SETTING_KEYS.API_PLATFORM_URL]: '',
  [SITE_SETTING_KEYS.API_PLATFORM_NAME]: 'API 平台',
  [SITE_SETTING_KEYS.NEW_API_BASE_URL]: '',
  [SITE_SETTING_KEYS.TASK_RETENTION_DAYS]: '30',
  // 存储配置默认值
  [SITE_SETTING_KEYS.STORAGE_TYPE]: 'local',
  [SITE_SETTING_KEYS.COS_SECRET_ID]: '',
  [SITE_SETTING_KEYS.COS_SECRET_KEY]: '',
  [SITE_SETTING_KEYS.COS_BUCKET]: 'new-api-1301453074',
  [SITE_SETTING_KEYS.COS_REGION]: 'ap-guangzhou',
}
