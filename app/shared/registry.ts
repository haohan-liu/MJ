...
export const PROVIDER_REGISTRY: ProviderMeta[] = [
  ...
  {
    apiFormat: 'nanobanana-openai',
    label: 'NanoBanana (OpenAI)',
    category: 'image',
    isAsync: false,
    supportedModelTypes: ['nanobanana', 'nanobanana-pro', 'nanobanana-2'],
  },
...
export const IMAGE_MODEL_REGISTRY: ModelTypeMeta[] = [
  ...
  },
  {
    ...
    category: 'image',
    icon: 'i-heroicons-sparkles',
    cardDisplay: { label: 'NanoBanana Pro', color: 'bg-orange-500/80' },
  ...
  },
  {
    ...
    category: 'image',
    icon: 'i-heroicons-sparkles',
    cardDisplay: { label: 'NanoBanana 2', color: 'bg-amber-500/80' },
